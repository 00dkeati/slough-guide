...
export const metadata: Metadata = {
  title: 'slough houses for sale | Property Information & Real Estate Guide',
  description: 'Complete property guide for slough houses for sale. Find homes, get market insights, and connect with local estate agents in Slough.',
  keywords: 'slough houses for sale, slough, hampshire, local information, community',
  openGraph: {
    title: 'slough houses for sale | Property Information & Real Estate Guide',
    description: 'Complete property guide for slough houses for sale. Find homes, get market insights, and connect with local estate agents in Slough.',
    url: 'https://slough.co/k/slough-houses-for-sale',
    type: 'website',
  },
  robots: {
    index: true,
...
export default function SloughhousesforsalePage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <div className="prose prose-lg max-w-none">
        
# slough houses for sale - Property Guide

Your comprehensive guide to slough houses for sale in Slough, including market information, property types, and local insights.
