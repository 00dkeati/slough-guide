...
export const metadata: Metadata = {
  title: 'jobs slough part time | Job Opportunities & Employment Guide',
  description: 'Find jobs slough part time opportunities in Slough. Browse local jobs, career advice, and employment information for the area.',
  keywords: 'jobs slough part time, slough, hampshire, local information, community',
  openGraph: {
    title: 'jobs slough part time | Job Opportunities & Employment Guide',
    description: 'Find jobs slough part time opportunities in Slough. Browse local jobs, career advice, and employment information for the area.',
    url: 'https://slough.co/k/jobs-slough-part-time',
    type: 'website',
  },
  robots: {
    index: true,
...
export default function JobssloughparttimePage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <div className="prose prose-lg max-w-none">
        
# jobs slough part time - Employment Opportunities

Discover exciting career opportunities with jobs slough part time in Slough and surrounding areas.
