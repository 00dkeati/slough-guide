...
export const metadata: Metadata = {
  title: 'slough jobs part time | Job Opportunities & Employment Guide',
  description: 'Find slough jobs part time opportunities in Slough. Browse local jobs, career advice, and employment information for the area.',
  keywords: 'slough jobs part time, slough, hampshire, local information, community',
  openGraph: {
    title: 'slough jobs part time | Job Opportunities & Employment Guide',
    description: 'Find slough jobs part time opportunities in Slough. Browse local jobs, career advice, and employment information for the area.',
    url: 'https://slough.co/k/slough-jobs-part-time',
    type: 'website',
  },
  robots: {
    index: true,
...
export default function SloughjobsparttimePage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <div className="prose prose-lg max-w-none">
        
# slough jobs part time - Employment Opportunities

Discover exciting career opportunities with slough jobs part time in Slough and surrounding areas.
