...
export const metadata: Metadata = {
  title: 'slough wickes | Store Information & Shopping Guide',
  description: 'Complete guide to slough wickes. Store details, opening hours, location, and shopping information for Slough.',
  keywords: 'slough wickes, slough, hampshire, local information, community',
  openGraph: {
    title: 'slough wickes | Store Information & Shopping Guide',
    description: 'Complete guide to slough wickes. Store details, opening hours, location, and shopping information for Slough.',
    url: 'https://slough.co/k/slough-wickes',
    type: 'website',
  },
  robots: {
    index: true,
...
# slough wickes - Shopping Information

Your complete guide to slough wickes in Slough, including store details, services, and shopping information.

## About slough wickes

slough wickes is a popular shopping destination in Slough, offering a wide range of products and services to meet the needs of local residents and visitors.

## Store Information

### Location
slough wickes is conveniently located in Slough with:
...
slough wickes regularly offers:
- Seasonal promotions
- Special discounts
- Community events
- Loyalty programs
...
Shopping at slough wickes supports:
- Local employment
