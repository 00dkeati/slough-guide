...
export const metadata: Metadata = {
  title: 'slough asda | Store Information & Shopping Guide',
  description: 'Complete guide to slough asda. Store details, opening hours, location, and shopping information for Slough.',
  keywords: 'slough asda, slough, hampshire, local information, community',
  openGraph: {
    title: 'slough asda | Store Information & Shopping Guide',
    description: 'Complete guide to slough asda. Store details, opening hours, location, and shopping information for Slough.',
    url: 'https://slough.co/k/slough-asda',
    type: 'website',
  },
  robots: {
    index: true,
...
# slough asda - Shopping Information

Your complete guide to slough asda in Slough, including store details, services, and shopping information.

## About slough asda

slough asda is a popular shopping destination in Slough, offering a wide range of products and services to meet the needs of local residents and visitors.

## Store Information

### Location
slough asda is conveniently located in Slough with:
...
Shopping at slough asda supports:
- Local employment
