...
export const metadata: Metadata = {
  title: 'slough property for sale | Property Information & Real Estate Guide',
  description: 'Complete property guide for slough property for sale. Find homes, get market insights, and connect with local estate agents in Slough.',
  keywords: 'slough property for sale, slough, hampshire, local information, community',
  openGraph: {
    title: 'slough property for sale | Property Information & Real Estate Guide',
    description: 'Complete property guide for slough property for sale. Find homes, get market insights, and connect with local estate agents in Slough.',
    url: 'https://slough.co/k/slough-property-for-sale',
    type: 'website',
  },
  robots: {
    index: true,
...
export default function SloughpropertyforsalePage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <div className="prose prose-lg max-w-none">
        
# slough property for sale - Property Guide

Your comprehensive guide to slough property for sale in Slough, including market information, property types, and local insights.
