...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: `weather slough 7 days in Slough – Local Guide, Info & Tips`,
    description: `Everything you need to know about weather slough 7 days in Slough. Local guide with practical information, tips, and insights for residents and visitors.`,
    openGraph: {
      title: `weather slough 7 days in Slough – Local Guide, Info & Tips`,
      description: `Everything you need to know about weather slough 7 days in Slough. Local guide with practical information, tips, and insights for residents and visitors.`,
      type: 'article',
    ...
    alternates: {
      canonical: `/editorial/weather-slough-7-days`,
    },
  }
}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Article",
            "headline": "weather slough 7 days in Slough – Local Guide, Info & Tips",
            "description": "Everything you need to know about weather slough 7 days in Slough. Local guide with practical information, tips, and insights for residents and visitors.",
            "author": {
              "@type": "Organization",
              "name": "Slough.co"
            ...
            "datePublished": "2025-10-18T19:15:01.030Z",
            "dateModified": "2025-10-18T19:15:01.030Z",
            "mainEntityOfPage": {
              "@type": "WebPage",
              "@id": "https://www.slough.co/editorial/weather-slough-7-days"
            }
          })
        }}
      />
      ...
      <main className="pt-20 lg:pt-24">
        <div className="mx-auto w-full max-w-screen-xl px-4 sm:px-6 lg:px-8">
          ...
          <nav className="mb-6 text-sm text-gray-600">
            ...
            <span className="mx-2">›</span>
            <span className="text-gray-900">weather slough 7 days</span>
          </nav>
