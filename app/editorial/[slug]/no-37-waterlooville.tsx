...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: `no 37 slough in Slough – Local Guide, Info & Tips`,
    description: `Everything you need to know about no 37 slough in Slough. Local guide with practical information, tips, and insights for residents and visitors.`,
    openGraph: {
      title: `no 37 slough in Slough – Local Guide, Info & Tips`,
      description: `Everything you need to know about no 37 slough in Slough. Local guide with practical information, tips, and insights for residents and visitors.`,
      type: 'article',
    ...
    alternates: {
      canonical: `/editorial/no-37-slough`,
    },
  }
}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Article",
            "headline": "no 37 slough in Slough – Local Guide, Info & Tips",
            "description": "Everything you need to know about no 37 slough in Slough. Local guide with practical information, tips, and insights for residents and visitors.",
            "author": {
              "@type": "Organization",
              "name": "Slough.co"
            ...
            "mainEntityOfPage": {
              "@type": "WebPage",
              "@id": "https://www.slough.co/editorial/no-37-slough"
            }
          })
        }}
      />
      ...
      <main className="pt-20 lg:pt-24">
        <div className="mx-auto w-full max-w-screen-xl px-4 sm:px-6 lg:px-8">
          ...
          <nav className="mb-6 text-sm text-gray-600">
            ...
            <span className="mx-2">›</span>
            <span className="text-gray-900">no 37 slough</span>
          </nav>
