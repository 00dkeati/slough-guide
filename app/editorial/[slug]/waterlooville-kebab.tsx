...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: `slough kebab in Slough – Local Guide, Info & Tips`,
    description: `Everything you need to know about slough kebab in Slough. Local guide with practical information, tips, and insights for residents and visitors.`,
    openGraph: {
      title: `slough kebab in Slough – Local Guide, Info & Tips`,
      description: `Everything you need to know about slough kebab in Slough. Local guide with practical information, tips, and insights for residents and visitors.`,
      type: 'article',
    ...
    alternates: {
      canonical: `/editorial/slough-kebab`,
    },
  }
}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Article",
            "headline": "slough kebab in Slough – Local Guide, Info & Tips",
            "description": "Everything you need to know about slough kebab in Slough. Local guide with practical information, tips, and insights for residents and visitors.",
            "author": {
              "@type": "Organization",
              "name": "Slough.co"
            ...
            "mainEntityOfPage": {
              "@type": "WebPage",
              "@id": "https://www.slough.co/editorial/slough-kebab"
            }
          })
        }}
      />
      ...
      <main className="pt-20 lg:pt-24">
        <div className="mx-auto w-full max-w-screen-xl px-4 sm:px-6 lg:px-8">
          ...
          <nav className="mb-6 text-sm text-gray-600">
            ...
            <span className="mx-2">›</span>
            <span className="text-gray-900">slough kebab</span>
          </nav>
