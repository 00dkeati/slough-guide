...
// Service slug mappings for broken links
const serviceMappings: Record<string, string> = {
  'barbers-slough': 'barbers',
  'care-home-slough': 'care-homes',
  'chinese-takeaway-slough': 'takeaways',
  'dentist-slough': 'dentists',
  'estate-agents-slough': 'estate-agents',
  'florist-slough': 'florists',
  'hairdresser-slough': 'hair-salons',
  'locksmiths-slough': 'locksmiths',
  'massage-slough': 'massage-therapists',
  'nursery-slough': 'nurseries',
  'restaurants-slough': 'restaurants',
  'takeaway-slough': 'takeaways'
}

export async function generateMetadata({ params }: ServicePageProps): Promise<Metadata> {
  // Extract category from slug (remove -slough suffix)
  const baseSlug = params.slug.replace('-slough', '')
  const mappedCategory = serviceMappings[params.slug]
  ...
  return (
    <>
      ...
      <Breadcrumbs items={[
        ...
        { label: category.name, href: `/services/${params.slug}` }
      ]} />
        ...
        <div className="lg:col-span-3">
          ...
          <section className="mb-8 bg-gradient-to-r from-blue-50 to-indigo-50 border-2 border-blue-200 rounded-xl p-6">
            ...
            <div className="prose prose-lg max-w-none text-gray-700">
              <p className="mb-4">
                Slough is home to a thriving community of professional {category.name.toLowerCase()}, each bringing years of experience and local expertise to serve residents and businesses across the area. Our directory showcases the most trusted and highly-rated service providers who have built their reputation through consistent quality and customer satisfaction.
              </p>
              <p className="mb-4">
                Whether you're looking for routine maintenance, emergency services, or specialized projects, our curated selection of {category.name.toLowerCase()} ensures you'll find professionals who meet your specific requirements and budget. Each business has been carefully vetted for reliability, professionalism, and customer service excellence.
              </p>
            </div>
          </section>
            ...
            <div className="grid md:grid-cols-3 gap-4">
              <div className="bg-white rounded-lg p-4 shadow-sm">
                ...
                <p className="text-gray-700 text-sm">
                  Professional {category.name.toLowerCase()} bring specialized training, industry certifications, and years of experience to every project.
                </p>
              </div>
              <div className="bg-white rounded-lg p-4 shadow-sm">
                <h3 className="font-semibold text-gray-800 mb-2">Quality Assurance</h3>
                <p className="text-gray-700 text-sm">
                  Licensed and insured professionals provide warranties and guarantees, ensuring your investment is protected.
                </p>
              </div>
              <div className="bg-white rounded-lg p-4 shadow-sm">
                <h3 className="font-semibold text-gray-800 mb-2">Local Expertise</h3>
                <p className="text-gray-700 text-sm">
                  Local {category.name.toLowerCase()} understand Slough's specific needs, regulations, and community preferences.
                </p>
              </div>
            </div>
          </section>
