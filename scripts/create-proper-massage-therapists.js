...
const actualMassageTherapists = businesses.filter(business => {
  ...
  const isWellnessBusiness = (
    name.includes('massage') || 
    name.includes('spa') || 
    name.includes('therapy') || 
    name.includes('wellness')
  ) && !name.includes('electrical') && !name.includes('landscape') && !name.includes('cleaning');
  
  return isMassageTherapist || isBeautySalon || isPhysiotherapist || isWellnessBusiness;
});
